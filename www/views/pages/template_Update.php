<form action="/Update/Update/?id=<?php echo $item->id; ?>" method="post">
    ...
    <div><textarea id="text_news" rows="10" cols="25" maxlength="250" name="text_news"
                   placeholder="<?php echo $item->text_news; ?>"></textarea></div>
